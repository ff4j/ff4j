...
public class FeatureStoreCassandraTestAstra extends AsbtractFeatureStoreCassandraTest {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(FeatureStoreCassandraTestAstra.class);

    /** {@inheritDoc} */
    @Override
    public CqlSession initCqlSession() {
        String configFile = 
                FeatureStoreCassandraTestAstra.class.getResource("/application_astra.conf").getFile();
