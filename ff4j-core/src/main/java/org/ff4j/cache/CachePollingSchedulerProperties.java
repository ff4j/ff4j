 ...
 */
public class CachePollingSchedulerProperties extends CachePollingScheduler < Property<?> > {
     ...
     */
    public CachePollingSchedulerProperties(RepositoryProperties sf, CacheManager<String, Property<?>> cp) {
