...
/**
 * This test will test FF4J class initializations through different
 * constructor but also with static access.
 *
...
public class FF4jInitializationTest {
	...
	public void testInitStaticSingleton() {
		FF4j f4 = new FF4j(new InMemoryFeatureStore(), new DefaultAuthorisationManager());
