...
import org.ff4j.store.FeatureStoreNeo4J;
...
public class DefaultUnitTesting implements FF4jNeo4jConstants {
    ...
    public void prepareTestDatabase() {
        ...
        try (Transaction tx2= graphDb.beginTx() ) {
            ...
            graphDb.execute("CREATE (AwesomeFeature:FF4J_FEATURE { uid:'AwesomeFeature', enable:true, description:'some desc' }),\n"
                    ...
                    + " (stratforth:FF4J_FLIPPING_STRATEGY { clazz:'org.ff4j.strategy.el.ExpressionFlipStrategy', initParams: [ 'expression=third|second' ]}),\n"
    ...
    public void importDataBase() {
        ...
        System.out.println(ff4j.getStartTime());
    }
