...
import org.ff4j.v1.mapper.PropertyMapper;
import org.ff4j.v1.property.Property;
import org.ff4j.v1.property.store.AbstractPropertyStore;
...
public class KeyValuePropertyStore < VALUE >  extends AbstractPropertyStore {
    ...
    public <T> void createProperty(Property<T> property) {
        ...
        getDriver().putValue(
                ...
                propertyMapper.mapToRepository(property));
    ...
    public Property<?> readProperty(String name) {
        ...
        return getPropertyMapper().mapFromRepository(
    ...
    public Map<String, Property<?>> readAllProperties() {
        ...
        for(String propertyName : getDriver().getPropertyList()) {
            Property<?> currP = getPropertyMapper().mapFromRepository(getDriver().getValue(
