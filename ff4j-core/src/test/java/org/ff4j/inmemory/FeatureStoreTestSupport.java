...
/**
 * Abtract class used to test multiple implementation of {@link RepositoryFeatures} in order to behave the
 * same.
 * 
 * @author <a href="mailto:cedrick.lunven@gmail.com">Cedrick LUNVEN</a>
 */
public abstract class FeatureStoreTestSupport implements FF4jTestDataSet {
	...
	/** Tested Store. */
	protected RepositoryFeatures testedStore;
	 ...
	 */
	protected abstract RepositoryFeatures initStore();

	// Same tests as V1 to ensure some of background compatibility
	@Test
	@DisplayName("When reading features, I should have the expected test DataSet")
	public void testLoadingTestDataSet() {
	    // Given
        ...
        Assertions.assertTrue(f4.getDescription() != null && !"".equals(f4.getDescription()));
        Assertions.assertTrue(f4.getAccessControlList() != null);
