...
public class RepositoryFeaturesInMemory extends AbstractRepositoryFeatures {
     ...
     *      target file name
     */
    public RepositoryFeaturesInMemory(ConfigurationFileParser parser, String fileName) {
     ...
     *      target file name
     */
    public RepositoryFeaturesInMemory(ConfigurationFileParser parser, InputStream in) {
        AssertUtils.assertNotNull(parser,  "parser");
