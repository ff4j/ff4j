...
import org.ff4j.v1.mapper.FeatureMapper;
import org.ff4j.v1.store.AbstractFeatureStore;
...
public abstract class KeyValueFeatureStore < VALUE > extends AbstractFeatureStore {
    ...
    public void update(Feature feature) {
        ...
        getDriver().putValue(
                ...
                getFeatureMapper().mapToRepository(feature));
    }
    ...
    public Feature read(String uid) {
        ...
        return getFeatureMapper().mapFromRepository(
    ...
    public Map<String, Feature> readAll() {
        ...
        for(String featureName : getDriver().getFeatureList()) {
            Feature currF = getFeatureMapper().mapFromRepository(getDriver().getValue(
