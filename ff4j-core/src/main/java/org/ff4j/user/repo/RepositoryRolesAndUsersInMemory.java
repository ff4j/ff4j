 ...
 */
public class RepositoryRolesAndUsersInMemory extends RepositoryRolesAndUsersSupport {
     ...
     * Default constructor.
     */
    public RepositoryRolesAndUsersInMemory() {}
     ...
     *          target fileName
     */
    public RepositoryRolesAndUsersInMemory(String fileName) {
     ...
     *          target fileName
     */
    public RepositoryRolesAndUsersInMemory(InputStream inputStream) {
     ...
     *      target file name
     */
    public RepositoryRolesAndUsersInMemory(ConfigurationFileParser parser, String fileName) {
     ...
     *      target file name
     */
    public RepositoryRolesAndUsersInMemory(ConfigurationFileParser parser, InputStream in) {
        AssertUtils.assertNotNull(parser,  "parser");
     ...
     */
    public RepositoryRolesAndUsersInMemory(FF4jConfigFile ff4jConfig) {
     ...
     */
    public RepositoryRolesAndUsersInMemory(Collection<FF4jUser> users) {
        initWithUsers(users);
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected void createUser(FF4jUser user) {
        preUpdate(user);
    ...
    /** {@inheritDoc} */
    @Override
    protected void updateUser(FF4jUser user) {
        assertNotNull(user);
    ...
    protected void deleteAllFeatures() {
        // instead of clear to have the notification
