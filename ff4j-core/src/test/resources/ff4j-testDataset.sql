...
INSERT INTO FF4J_PROPERTY 
		(UID, CREATED, LASTMODIFIED, OWNER, DESCRIPTION, CLASSNAME, READONLY, VAL, FIXEDVALUES) 
VALUES ('pBigDecimal', NULL, NULL, NULL, NULL, 'bigDecimal', '0', '1.5', NULL), 
	   ('pBigInteger', NULL, NULL, NULL, NULL, 'bigInteger', '0', '123456', NULL),
	   ('pBoolean', NULL, NULL, NULL, NULL, 'boolean', '0', 'true', NULL), 
	   ('pByte', NULL, NULL, NULL, NULL, 'byte', '0', 'p', NULL),
	   ('pCalendar', NULL, NULL, NULL, NULL, 'calendar', '0', '2018-12-24 23:00:00', NULL), 
	   ('pDate', NULL, NULL, NULL, NULL, 'date', '0', '2018-12-24 23:00:00', NULL),
	   ('pClass', NULL, NULL, NULL, NULL, 'class', '0', 'java.lang.String', NULL), 
	   ('pDouble', NULL, NULL, NULL, NULL, 'double', '0', '20.0', NULL),
	   ('pFloat', NULL, NULL, NULL, NULL, 'float', '0', '20.0', NULL), 
	   ('pInstant', NULL, NULL, NULL, NULL, 'instant', '0', '2018-12-24 23:00:00', NULL),
	   ('pLocal', NULL, NULL, NULL, NULL, 'localDateTime', '0', '2018-12-24 23:00:00', NULL), 
	   ('pInt', NULL, NULL, NULL, NULL, 'int', '0', '10', NULL),
	   ('pLogLevel', NULL, NULL, NULL, NULL, 'logLevel', '0', 'INFO', NULL), 
	   ('pLong', NULL, NULL, NULL, NULL, 'long', '0', '123', NULL),
	   ('pShort', NULL, NULL, NULL, NULL, 'short', '0', '5', NULL), 
	   ('pString', NULL, NULL, NULL, NULL, 'string', '0', 'pString', NULL),
	   ('pListBigDecimal', NULL, NULL, NULL, NULL, 'listBigDecimal', '0', '1.5,2.5', NULL), 
	   ('pListBigInteger', NULL, NULL, NULL, NULL, 'listBigInteger', '0', '123456,789012', NULL),
	   ('pListBoolean', NULL, NULL, NULL, NULL, 'listBoolean', '0', 'true,false', NULL), 
	   ('pListByte', NULL, NULL, NULL, NULL, 'listByte', '0', 'p,l', NULL),
	   ('pListCalendar', NULL, NULL, NULL, NULL, 'listCalendar', '0', '2018-12-24 23:00:00,2019-01-01 23:00:00', NULL), 
	   ('pListDate', NULL, NULL, NULL, NULL, 'listDate', '0', '2018-12-24 23:00:00,2019-01-01 23:00:00', NULL),
	   ('pListClass', NULL, NULL, NULL, NULL, 'listClass', '0', 'java.lang.String,java.lang.Integer', NULL), 
	   ('pListDouble', NULL, NULL, NULL, NULL, 'listDouble', '0', '20.0,30.0', NULL),
	   ('pListFloat', NULL, NULL, NULL, NULL, 'listFloat', '0', '20.0,30.0', NULL), 
	   ('plistInstant', NULL, NULL, NULL, NULL, 'listInstant', '0', '2018-12-24 23:00:00,2019-01-01 23:00:00', NULL),
	   ('pListInt', NULL, NULL, NULL, NULL, 'listInt', '0', '10,20', NULL), 
	   ('pListLogLevel', NULL, NULL, NULL, NULL, 'listLogLevel', '0', 'INFO,DEBUG', NULL),
	   ('pListLong', NULL, NULL, NULL, NULL, 'listLong', '0', '123,456', NULL), 
	   ('pListShort', NULL, NULL, NULL, NULL, 'listShort', '0', '5,6', NULL),
	   ('pListString', NULL, NULL, NULL, NULL, 'listString', '0', 'pString,listString', NULL), 
	   ('pListLocal', NULL, NULL, NULL, NULL, 'listLocalDateTime', '0', '2018-12-24 23:00:00,2019-01-01 23:00:00', NULL);
