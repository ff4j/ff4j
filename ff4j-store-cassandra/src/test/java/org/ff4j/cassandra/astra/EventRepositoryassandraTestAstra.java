...
@Ignore
public class EventRepositoryassandraTestAstra extends AsbtractEventRepositoryCassandraTest {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(EventRepositoryassandraTestAstra.class);

    /** {@inheritDoc} */
    @Override
    public CqlSession initCqlSession() {
        String configFile = 
                EventRepositoryassandraTestAstra.class.getResource("/application_astra.conf").getFile();
